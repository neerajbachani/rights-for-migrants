...
//       // --- Horizontal tracks animation - NOW starts when section enters viewport ---
//       gsap.to(".track-1", {
//         xPercent: -40,
//         ease: "none",
...
//       // --- Quotes timeline: improved timing and responsiveness ---
//       const quotesTL = gsap.timeline({
//         scrollTrigger: {
//           trigger: wrapperRef.current,
//           start: "top top",
//           end: "+=200%",
//           scrub: 0.5, // Lower scrub value for more responsive animations
//           markers: false,
//         },
//       });
...
//       quotesTL.to(".quote-1", { y: 200, autoAlpha: 0.8, duration: 1 }, 2);
...
export function ScrollPinnedContainer() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Track 1 - Moves right to left (slow)
      gsap.to(".track-1", {
        xPercent: -30,  // Reduced distance
        ease: "none",
        scrollTrigger: {
          trigger: wrapperRef.current,
          start: "top bottom",
          end: "bottom top",  // Enabled for longer animation
          scrub: 2,  // Higher = slower
          markers: false,
        },
      });

      // Track 2 - Moves left to right (slow)
      gsap.set(".track-2", { xPercent: -30 });  // Starts slightly left
      gsap.to(".track-2", {
        xPercent: 0,  // Reduced travel distance (was -90 to 40 = 130%)
        ease: "none",
        scrollTrigger: {
          trigger: wrapperRef.current,
          start: "top bottom",
          end: "bottom top",  // Enabled for longer animation
          scrub: 2.2,  // Slower than track 1
          markers: false,
        },
      });

      // Track 3 - Moves right to left (slowest)
      gsap.to(".track-3", {
        xPercent: -25,  // Reduced distance
        ease: "none",
        scrollTrigger: {
          trigger: wrapperRef.current,
          start: "top bottom",
