...
export default function FormSubmissionDetail({
  ...
  return (
    <div className=" fixed -mt-14 p-20 inset-0 z-50">
      <div className="flex min-h-full items-end justify-center  text-center sm:items-center sm:p-0">
        ...
        {/* Dialog (higher z so it receives touch) */}
        <div className="relative transform rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl z-30">
          {/* Container with fixed height so inner area can scroll */}
          <div className="flex h-[100vh] w-full flex-col">
            {/* Header (sticky) */}
            <div className="flex items-start justify-between p-4 border-b sticky top-0 z-40 bg-white">
              <div className="flex items-center">
                <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
                  <svg
                    className="h-6 w-6 text-blue-600"
            ...
            {/* Scrollable content area
                ...
                - overscroll-contain => avoid page behind from scrolling on some browsers
            */}
            <div
            ...
            <div className="p-4 border-t sticky bottom-0 z-40 bg-white flex items-center justify-between">
              <button
                onClick={handleDelete}
                disabled={isUpdatingStatus}
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
